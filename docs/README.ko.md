...
- **[OpenLogi GUI](../crates/openlogi-gui)** — GPUI 데스크톱 앱: 클릭 가능한 핫스팟이 있는 인터랙티브 마우스 다이어그램, 버튼별 액션 선택기(내장 액션 41개 + 녹화한 사용자 지정 단축키), DPI 프리셋, SmartShift 패널(휠 모드·감도·영구 래칫), 앱별 프로필 오버레이, 페어링된 기기를 실시간 전환하는 기기 캐러셀, 그리고 20개 언어로 현지화된 설정 창.
...
| 41개 액션 카탈로그 + 녹화한 사용자 지정 키보드 단축키 | ✅ macOS + Linux¹ |
