...
- **[OpenLogi GUI](../crates/openlogi-gui)** —— 基于 GPUI 的桌面应用：可点击热区的交互式鼠标示意图、逐按键动作选择器（41 个内置动作 + 录制的自定义快捷键）、DPI 预设、SmartShift 面板（滚轮模式、灵敏度、永久棘轮）、按应用的配置叠加层、可在已配对设备间实时切换的设备轮播，以及一个界面已本地化为 20 种语言的设置窗口。
...
| 41 个动作目录 + 录制的自定义键盘快捷键 | ✅ macOS + Linux¹ |
