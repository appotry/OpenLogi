...
use crate::{
    ...
    feature::{
        ...
        extended_report_rate::ExtendedReportRateFeature, feature_set::FeatureSetFeature,
        fn_inversion::FnInversionMultiHostFeature, hires_wheel::HiResWheelFeature,
        hosts_info::HostsInfoFeature, mode_status::ModeStatusFeature,
        multi_platform::MultiPlatformFeature, report_rate::ReportRateFeature,
        reprog_controls::ReprogControlsFeature, root::RootFeature, sidetone::SidetoneFeature,
        smartshift::SmartShiftFeature, smartshift_enhanced::SmartShiftEnhancedFeature,
